...
console.group('2. Implementuokite figūrų abstrakciją ir polimorfizmą naudojant interface\'ą');
{
  ...
  // 5min
  console.log('2.1. Sukurkite abstrakčią interface`ą Shape2D, kuri turėtų 2 abstrakčius metodus. Abu šie metodai neturi parametrų ir grąžina skaičių: "getPerimeter" ir "getArea"');
